...
/**
 * Read-only projection of a shipment returned across tier boundaries
 * (EJB remote interface, JAX-RS resource). Decoupling this from the
 * {@code Shipment} JPA entity means the web tier and any remote carrier/
 * vendor client never receive a detached entity with lazy associations
 * that would throw outside of a persistence context.
 */
