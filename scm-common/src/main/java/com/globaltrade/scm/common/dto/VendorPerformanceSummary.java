...
/**
 * Aggregate vendor performance snapshot, returned by the asynchronous
 * vendor assessment operation. Serializable so it can travel over the
 * {@code Future<VendorPerformanceSummary>} returned by an
 * {@code @Asynchronous} EJB method to a remote caller.
 */
